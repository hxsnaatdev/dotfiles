# AUTO GENERATED BY 'fish-lsp' COMMAND
#
...
# REPO URL: https://github.com/ndonfris/fish-lsp.git
...
function __fish_lsp_get_features -d 'print all features controlled by the server, not yet used in the commandline'
    set -l all_features complete hover rename definition implementation reference formatting formatRange typeFormatting codeAction codeLens folding signature executeCommand inlayHint highlight diagnostic popups semanticTokens
...
function __fish_lsp_get_env_variables -d 'print all fish_lsp_* env variables, not yet used in the commandline'
    ...
    set -l env_names_with_descriptions "fish_lsp_enabled_handlers\t'server handlers to enable'" \
        ...
        "fish_lsp_max_diagnostics\t'maximum number of diagnostics to return per file'" \
        "fish_lsp_enable_experimental_diagnostics\t'enable fish-lsp's experimental diagnostics'" \
        "fish_lsp_strict_conditional_command_warnings\t'diagnostic `3002` show warnings for syntax like `command ls || echo 'no ls'`'" \
        "fish_lsp_prefer_builtin_fish_commands\t'prefer built-in fish commands over external shell commands'" \
        "fish_lsp_allow_fish_wrapper_functions\t'prefer the user to use primitive fish commands instead of wrapper utilities common in other shells'" \
        "fish_lsp_require_autoloaded_functions_to_have_description\t'enable showing diagnostic `4008`'" \
        ...
        "fish_lsp_ignore_paths\t'paths to ignore when indexing'" \
        "fish_lsp_max_workspace_depth\t'maximum directory depth to search for fish files on startup'" \
        "fish_lsp_fish_path\t'specific binary to use for executing 'fish' commands inside server'"
...
#########################################################################################################################
### generated output time:      15/05/26, 2:14:56 pm                                                                  ###
### binary build time:          12/18/25, 1:57:40 AM                                                                  ###
### binary build path:          /opt/homebrew/Cellar/fish-lsp/1.1.3/libexec/lib/node_modules/fish-lsp/dist/fish-lsp   ###
### binary build version:       1.1.3                                                                                 ###
### report issues:              https://github.com/ndonfris/fish-lsp/issues                                           ###
#########################################################################################################################
